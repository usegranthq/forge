...
func (pu *ProjectUpdate) AddOidcClients(o ...*OidcClient) *ProjectUpdate {
	ids := make([]uuid.UUID, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return pu.AddOidcClientIDs(ids...)
}
...
func (pu *ProjectUpdate) ClearOidcClients() *ProjectUpdate {
	pu.mutation.ClearOidcClients()
	return pu
}

// RemoveOidcClientIDs removes the "oidc_clients" edge to OidcClient entities by IDs.
func (pu *ProjectUpdate) RemoveOidcClientIDs(ids ...uuid.UUID) *ProjectUpdate {
	pu.mutation.RemoveOidcClientIDs(ids...)
	return pu
}

// RemoveOidcClients removes "oidc_clients" edges to OidcClient entities.
func (pu *ProjectUpdate) RemoveOidcClients(o ...*OidcClient) *ProjectUpdate {
	ids := make([]uuid.UUID, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return pu.RemoveOidcClientIDs(ids...)
}
...
func (pu *ProjectUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.OidcClientsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := pu.mutation.RemovedOidcClientsIDs(); len(nodes) > 0 && !pu.mutation.OidcClientsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   project.OidcClientsTable,
	...
	if nodes := pu.mutation.OidcClientsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   project.OidcClientsTable,
...
// AddOidcClients adds the "oidc_clients" edges to the OidcClient entity.
func (puo *ProjectUpdateOne) AddOidcClients(o ...*OidcClient) *ProjectUpdateOne {
	ids := make([]uuid.UUID, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return puo.AddOidcClientIDs(ids...)
}
...
// ClearOidcClients clears all "oidc_clients" edges to the OidcClient entity.
func (puo *ProjectUpdateOne) ClearOidcClients() *ProjectUpdateOne {
	puo.mutation.ClearOidcClients()
	return puo
}

// RemoveOidcClientIDs removes the "oidc_clients" edge to OidcClient entities by IDs.
func (puo *ProjectUpdateOne) RemoveOidcClientIDs(ids ...uuid.UUID) *ProjectUpdateOne {
	puo.mutation.RemoveOidcClientIDs(ids...)
	return puo
}

// RemoveOidcClients removes "oidc_clients" edges to OidcClient entities.
func (puo *ProjectUpdateOne) RemoveOidcClients(o ...*OidcClient) *ProjectUpdateOne {
	ids := make([]uuid.UUID, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return puo.RemoveOidcClientIDs(ids...)
}
...
func (puo *ProjectUpdateOne) sqlSave(ctx context.Context) (_node *Project, err error) {
	...
	if puo.mutation.OidcClientsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   project.OidcClientsTable,
	...
	if nodes := puo.mutation.RemovedOidcClientsIDs(); len(nodes) > 0 && !puo.mutation.OidcClientsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   project.OidcClientsTable,
	...
	if nodes := puo.mutation.OidcClientsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   project.OidcClientsTable,
