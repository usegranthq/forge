...
// ForeignKeys holds the SQL foreign-keys that are owned by the "verifications"
...
const (
	...
	TypeEMAIL_UPDATE Type = "EMAIL_UPDATE"
)
...
func TypeValidator(_type Type) error {
	switch _type {
	case TypeSIGNUP, TypeEMAIL_UPDATE:
		return nil
	default:
		return fmt.Errorf("verification: invalid enum value for type field: %q", _type)
	}
}
